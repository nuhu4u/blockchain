...
export default function ObserverForgotPasswordPage() {
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-slate-900">
              {currentStep === "email" && "Reset Observer Password"}
            ...
            <CardDescription>
              ...
              {currentStep === "otp" && "Enter the 6-digit code sent to your registered email"}
              ...
              <form onSubmit={handleOtpSubmit} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                  />
                  <p className="text-sm text-slate-500 mt-1">Code sent to registered email for {email}</p>
                </div>
              ...
              <div className="space-y-4 text-center">
                <Alert className="border-green-200 bg-green-50">
                  ...
                  <AlertDescription className="text-green-800">
                    Your password has been successfully reset. You can now log in to the observer portal with your new
                    password.
                  </AlertDescription>
                </Alert>
                <Button
                  className="w-full bg-green-600 hover:bg-green-700"
                  onClick={() => router.push("/observer/login")}
                >
                  Continue to Observer Login
                </Button>
              </div>
            )}
          </CardContent>
