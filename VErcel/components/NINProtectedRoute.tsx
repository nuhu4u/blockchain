...
interface NINProtectedRouteProps {
  children: ReactNode
  fallback?: ReactNode
}

export const NINProtectedRoute = ({ children, fallback }: NINProtectedRouteProps) => {
  const { isChecking, hasNIN, ninVerified, shouldRedirect, user } = useNINVerification()
